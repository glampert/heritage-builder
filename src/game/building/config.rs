    ...
    pub fn load() -> Self {
        Self {
            ...
            storage_yard: StorageConfig {
                ...
                min_workers: 0,
                max_workers: 1,
                goods_accepted: ConsumerGoodsList::with_all_items(),
                raw_materials_accepted: RawMaterialsList::with_all_items(),
                num_slots: 8,
                slot_capacity: 4,
            },
            storage_granary: StorageConfig {
                ...
                min_workers: 0,
                max_workers: 1,
                goods_accepted: ConsumerGoodsList::with_items_expanded(ConsumerGoodKind::any_food()),
